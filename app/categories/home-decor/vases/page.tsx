...
const vaseImages = [
  {
    ...
    image: '/categories/home-decor/Vases/vases (1).jpg',
    description: 'Beautiful ceramic vase with timeless design. Perfect for fresh or dried flower arrangements.',
  },
  {
    id: 2,
    name: 'Artisan Decorative Vase',
    image: '/categories/home-decor/Vases/vases (2).jpg',
    description: 'Handcrafted vase featuring quality materials and attention to detail. Ideal for standalone display or with florals.',
  },
];

export default function VasesPage() {
  const [selectedImage, setSelectedImage] = useState<(typeof vaseImages)[0] | null>(null);
      ...
      <div className="border-b border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <span>/</span>
            <span className="text-foreground">Vases</span>
          </div>
        </div>
      </div>
      ...
      <section className="border-b border-border bg-card/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl">
            From modern black ceramic and handcrafted wooden vases to hand-painted folk-art designs — find the right vase for flowers, dried stems, or standalone display.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-muted-foreground">
                Each vase works for fresh or dried arrangements, or as a standalone decorative piece on mantels, consoles, and tables.
              </p>
            </div>
            <div>
              <h3 className="text-lg font-medium text-foreground mb-3">
              ...
              <p className="text-muted-foreground">
                Ceramic, wood, and hand-painted finishes — from minimalist to folk-art — to suit every room and style.
              </p>
            </div>
            <div>
              <h3 className="text-lg font-medium text-foreground mb-3">
              ...
              <p className="text-muted-foreground">
                Thoughtful shapes and finishes ensure each vase looks good with or without flowers.
              </p>
            </div>
          </div>
        </div>
